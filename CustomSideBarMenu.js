...
export default class CustomSidebarMenu extends Component {
    constructor() {
        ...
        this.proileImage =
            'https://upload.wikimedia.org/wikipedia/sco/thumb/c/ca/Studio_Ghibli_logo.svg/800px-Studio_Ghibli_logo.svg.png';
                    ...
                    {this.items.map((item, key) => (
                        <View key={key}
                            ...
                            <Text
                                style={{
                                    fontSize: 15,
                                    color: global.currentScreenIndex === key ? '#08415C' : 'black',
                                }}
                                onPress={() => {
